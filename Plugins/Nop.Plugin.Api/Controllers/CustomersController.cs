...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class CustomersController : BaseApiController
    {
        ...
        public IHttpActionResult CreateCustomer([ModelBinder(typeof(JsonModelBinder<CustomerDto>))] Delta<CustomerDto> customerDelta)
        {
            ...
            // Moveleiros :)
            var lojistaId = customerDelta.Dto.LojistaId;
            var newStore = _storeService.GetStoreByLojistaId(lojistaId);
            if (newStore != null)
                _customerService.AttachStoreToCustomer(newCustomer, newStore.Id);
