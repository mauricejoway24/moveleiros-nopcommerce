...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageUsers = new PermissionRecord { Name = "Admin area. Manage Users", SystemName = "ManageUsers", Category = "Configuration" };
        ...
        public static readonly PermissionRecord DesignerCreate = new PermissionRecord { Name = "Designer area.Manage Projects", SystemName = "ManageProjects", Category = "Designer Features" };

        public static readonly PermissionRecord ManageLivechat = new PermissionRecord { Name = "Admin livechat area", SystemName = "ManageLivechat", Category = "Configuration" };
