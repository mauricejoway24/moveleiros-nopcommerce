...
namespace Nop.Services.Stores
{
    ...
    public partial interface IStoreMappingService
    {
        ...
        IPagedList<StoreMapping> GetAllPagedStoreMapping(string storeName,
            string entityName,
            int pageIndex,
            int pageSize,
        ...
        void InsertStoreMapping(int customerId, string entityName, int storeId);

        bool TableAuthorize<T>(T entity, int storeId) where T : BaseEntity;


        bool TableEdit(int storeId);

        bool TableEdit(int entityId, string entityName);
