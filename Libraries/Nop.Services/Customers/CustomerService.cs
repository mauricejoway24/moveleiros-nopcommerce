    ...
    public partial class CustomerService : ICustomerService
    {
        ...
        public virtual IList<CustomerRole> GetAllCustomerRoles(bool showHidden = false)
        {
            ...
            return _cacheManager.Get(key, () =>
            {
                ...
                var _storeMappingService = Core.Infrastructure.EngineContext.Current.Resolve<Stores.IStoreMappingService>();
                int storeId = _storeMappingService.CurrentStore();
        ...
        public virtual void AttachStoreToCustomer(Customer customer, int storeId)
        {
            var _storeMappingService = Core.Infrastructure.EngineContext.Current.Resolve<Stores.IStoreMappingService>();
            var storeMappingRepository = Core.Infrastructure.EngineContext.Current.Resolve<IRepository<Core.Domain.Stores.StoreMapping>>();

            var exists = storeMappingRepository
                .Table
                .Any(t => t.EntityId == customer.Id && t.StoreId == storeId && t.EntityName == "Stores");

            if (!exists)
                _storeMappingService.InsertStoreMapping(customer.Id, "Stores", storeId);
        }
        #endregion
