...
namespace Nop.Services.Customers
{
    ...
    public partial class CustomerRegistrationService : ICustomerRegistrationService
    {
        ...
        public virtual CustomerRegistrationResult RegisterCustomer(CustomerRegistrationRequest request)
        {
            ...
            if (request.IsDesigner)
            {
                var designerRole = _customerService.GetCustomerRoleBySystemName(SystemCustomerRoleNames.Designer);
                if (designerRole == null)
                    throw new NopException("'Designer' role could not be loaded");
                request.Customer.CustomerRoles.Add(designerRole);
            }
