...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        public virtual Picture InsertPicture(
            ...
            PictureType pictureType = PictureType.Entity,
            ...
            bool isPanorama = false)
        {
            ...
            if (validateBinary && !ignoreSaveDb)
                pictureBinary = ValidatePicture(pictureBinary, mimeType);
            ...
            picture.IsNew = isNew;
            picture.PictureTypeId = (int)pictureType;
            picture.IsPanorama = isPanorama;

            _pictureRepository.Update(picture);

            if (!StoreInDb && !ignoreSaveDb)
                SavePictureInFile(picture.Id, pictureBinary, mimeType);
        ...
        /// <param name="seoFilename">The SEO filename</param>
        /// <returns>Picture</returns>
        public virtual Picture SetSeoFilename(
            int pictureId, 
            string seoFilename,
            PictureType pictureType = PictureType.Entity,
            bool isPanorama = false)
