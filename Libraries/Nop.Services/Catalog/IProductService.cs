...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// </summary>
        /// <param name="productPicture">Product picture</param>
        void DeleteProductColorPicture(ProductColor productPicture);
        ...
        /// <param name="productId">The product identifier</param>
        /// <returns>Product pictures</returns>
        IList<ProductColor> GetProductColorPicturesByProductId(int productId);
        ...
        /// <param name="productPictureId">Product picture identifier</param>
        /// <returns>Product picture</returns>
        ProductColor GetProductColorPictureById(int productPictureId);

        /// <summary>
        /// Inserts a product picture
        /// </summary>
        /// <param name="productPicture">Product picture</param>
        void InsertProductColorPicture(ProductColor productColor);

        /// <summary>
        /// Updates a product picture
        /// </summary>
        /// <param name="productPicture">Product picture</param>
        void UpdateProductColorPicture(ProductColor productPicture);
        ...
        /// <param name="productsIds">Products IDs</param>
        /// <returns>All picture identifiers grouped by product ID</returns>
        IDictionary<int, int[]> GetProductColorsImagesIds(int[] productsIds);
