...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<ProductColor> _productColors;
        ...
        /// <summary>
        /// Observation that is pulled right on main description
        /// </summary>
        public string AsideObservation { get; set; }

        /// <summary>
        /// Description that comes with dimension image
        /// </summary>
        public string DimensionDescription { get; set; } = string.Empty;
        ...
        /// Image object
        /// </summary>
        // public virtual Picture DimensionImage { get; set; }
        ...
        /// <summary>
        /// From which area this product should appear
        /// </summary>
        public int FromArea { get; set; } = 0;

        /// <summary>
        /// Until which area this product should appear
        /// </summary>
        public int ToArea { get; set; } = 0;

        /// <summary>
        /// Gets or sets the collection of ProductPicture for colors
        /// </summary>
        public virtual ICollection<ProductColor> ProductColors
        {
            get { return _productColors ?? (_productColors = new List<ProductColor>()); }
            protected set { _productColors = value; }
        }
