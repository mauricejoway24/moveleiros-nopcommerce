...
namespace Nop.Core.Domain.Stores
{
    ...
    public partial class Store : BaseEntity, ILocalizedEntity
    {
        ...
        /// <summary>
        /// Gets or sets the company neighborhood
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the chat script
        /// </summary>
        public string ChatScript { get; set; }

        /// <summary>
        /// Gets or sets the LojistaId
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the profile short url
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the BrandPictureId
        /// </summary>
