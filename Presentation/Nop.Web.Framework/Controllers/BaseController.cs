...
namespace Nop.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual int GetActiveStoreScopeConfiguration(IStoreService storeService, IWorkContext workContext)
        {
            ...
            List<int> storeIds = _storeMappingService.GetStoreIdByEntityId(workContext.CurrentCustomer.Id, "Stores");
            if (storeIds.Count > 0)
            {
                var store = storeService.GetAllStoresByEntityName(workContext.CurrentCustomer.Id, "Stores")[0];
