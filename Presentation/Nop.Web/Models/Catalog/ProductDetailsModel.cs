...
namespace Nop.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseNopEntityModel
    {
        ...
        public PictureModel BrandPictureModel { get; set; }
        public PictureModel LogoPictureModel { get; set; }
        ...
        public PictureModel DimensionPicture { get; set; }
        public PictureModel DefaultDimensionPicture { get; set; }

        public Brand Brand { get; set; }

        public IList<PictureModel> ColorPictureModels { get; set; }
        ...
        public string StoreShortAddress { get; set; }
        ...
        public partial class AddToCartModel : BaseNopModel
        {
            ...
            public string ProductName { get; set; }
            public int ProductInStoreId { get; set; }
            public string CtaCustomizationColor { get; set; }
            public string CtaCustomizationColorHover { get; set; }
