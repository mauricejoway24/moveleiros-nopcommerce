...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        public ProductModel()
        {
            ...
            ProductColorModels = new List<ProductPictureModel>();
            CopyProductModel = new CopyProductModel();
            AddPictureModel = new ProductPictureModel();
            AddPictureColorModel = new ProductPictureModel();
        ...
        [AllowHtml]
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProjectDescription")]
        public string ProjectDescription { get; set; } = string.Empty;

        [AllowHtml]
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ProjectContains")]
        public string ProjectContains { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.AsideObservation")]
        public string AsideObservation { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DimensionDescription")]
        public string DimensionDescription { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.CompareToPrice")]
        public decimal CompareToPrice { get; set; }

        [UIHint("Picture")]
        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.Dimension")]
        public int? DimensionImageId { get; set; }

        //public virtual ProductPicture DimensionImage { get; set; }
        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.Area")]
        public int Area { get; set; }

        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.FromArea")]
        public int FromArea { get; set; }

        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.ToArea")]
        public int ToArea { get; set; }

        // color pictures
        public ProductPictureModel AddPictureColorModel { get; set; }
        public IList<ProductPictureModel> ProductColorModels { get; set; }

        // brands
        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.Brand")]
        public int BrandId { get; set; }
        public IList<SelectListItem> AvailableBrands { get; set; }

        public bool IsAdminSupreme { get; set; }
        ...
        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.AdditionalShippingCharge")]
        ...
        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.Price")]
        public decimal Price { get; set; }

        [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Fields.OldPrice")]
        ...
        public partial class ProductPictureModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Pictures.Fields.OverrideAltAttribute")]
            [AllowHtml]
            ...
            [NopResourceDisplayName("Moveleiros.Admin.Catalog.Products.Pictures.Fields.IsPanorama")]
            public bool IsPanorama { get; set; }
        }

        public partial class ProductColorModel : BaseNopEntityModel
        {
            public int ProductId { get; set; }
