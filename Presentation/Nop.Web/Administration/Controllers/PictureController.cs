    ...
    public partial class PictureController : BaseAdminController
    {
        ...
        public virtual ActionResult AsyncUpload()
        {
            ...
            return Json(new { success = true, pictureId = picture.Id,
                imageUrl = _pictureService.GetPictureUrl(picture, 135) },
                MimeTypes.TextPlain);
        }
        ...
        //do not validate request token (XSRF)
        [AdminAntiForgery(true)]
        public virtual ActionResult AsyncUploadColorType()
        {
            Stream stream = null;
            var fileName = "";
            var contentType = "";
            ...
            var picture = _pictureService.InsertPicture(
                ...
                contentType, 
                null,
                pictureType: Core.Domain.Media.PictureType.Color);
            ...
            return Json(new
            {
                ...
                imageUrl = _pictureService.GetPictureUrl(
                    picture, 
                    100, 
                    defaultPictureType: Core.Domain.Media.PictureType.Color
                )
            }, MimeTypes.TextPlain);
        }
        ...
        //do not validate request token (XSRF)
        [AdminAntiForgery(true)]
        public virtual ActionResult AsyncUploadDimension()
        {
            Stream stream = null;
            var fileName = "";
            var contentType = "";
