...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        #region Extensions  by QuanNH StoreMapping

        public static StoreMappingModel ToModel(this StoreMapping entity)
        {
            return entity.MapTo<StoreMapping, StoreMappingModel>();
        }
