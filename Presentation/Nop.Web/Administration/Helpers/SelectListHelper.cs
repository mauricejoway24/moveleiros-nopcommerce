...
namespace Nop.Admin.Helpers
{
    ...
    public static class SelectListHelper
    {
        ...
        public static List<SelectListItem> GetCategoryList(ICategoryService categoryService, 
            ICacheManager cacheManager, 
            bool showHidden = false, 
            bool onlySubCategory = false)
        {
            ...
            string cacheKeyOnlySubCategory = string.Format($"{ModelCacheEventConsumer.CATEGORIES_LIST_KEY}_ONLY_SUB", showHidden);

            var listItems = cacheManager.Get(onlySubCategory ? cacheKeyOnlySubCategory : cacheKey, () =>
            {
                var categories = categoryService.GetAllCategories(showHidden: showHidden, onlySubCategory: onlySubCategory);
        ...
        public static List<SelectListItem> GetBrandList(IBrandService brandService, ICacheManager cacheManager, bool showHidden = false)
        {
            ...
            string cacheKey = string.Format(ModelCacheEventConsumer.BRANDS_LIST_KEY, showHidden);
            var listItems = cacheManager.Get(cacheKey, () =>
            {
                var vendors = brandService.GetAllBrands(showHidden: showHidden);
                return vendors.Select(v => new SelectListItem
                {
                    Text = v.Name,
                    Value = v.Id.ToString()
