...
namespace Nop.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        //available even when navigation is not allowed
        [PublicStoreAllowNavigation(true)]
        public virtual ActionResult Register(string systemName = "Customer")
        {
                        ...
                        case UserRegistrationType.EmailValidation:
                            {
                                ...
                                var _storeMappingService = Core.Infrastructure.EngineContext.Current.Resolve<IStoreMappingService>();
                                int getCustomer = _customerService.GetCustomerByEmail(customer.Email).Id;
                                _storeMappingService.InsertStoreMapping(getCustomer, "Stores", _storeContext.CurrentStore.Id);
